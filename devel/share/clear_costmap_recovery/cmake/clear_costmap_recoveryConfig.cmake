...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/nvidia/catkin_ws/src/navigation-noetic-devel/clear_costmap_recovery)
...
if(NOT "/home/nvidia/catkin_ws/src/navigation-noetic-devel/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/catkin_ws/src/navigation-noetic-devel/clear_costmap_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin_ws/src/navigation-noetic-devel/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
