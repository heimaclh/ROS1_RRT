...
set(MSG_I_FLAGS "-Iwheeltec_multi:/home/nvidia/catkin_ws/src/wheeltec_multi/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/noetic/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nvidia/catkin_ws/src/wheeltec_multi/msg/avoid.msg" NAME_WE)
add_custom_target(_wheeltec_multi_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "wheeltec_multi" "/home/nvidia/catkin_ws/src/wheeltec_multi/msg/avoid.msg" ""
)
...
_generate_msg_cpp(wheeltec_multi
  "/home/nvidia/catkin_ws/src/wheeltec_multi/msg/avoid.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/wheeltec_multi)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/wheeltec_multi\")")
  # install generated code
  install(
